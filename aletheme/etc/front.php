    ...
    <?php } ?>
    	...
    	<div class="comment_info">
        	...
        	<div class="info">
        		...
        		<?php if($depth == 1){ ?><span class="respond"><?php comment_reply_link(array_merge( $args, array('add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth']))) ?><i class="fa fa-reply" aria-hidden="true"></i></span><?php } ?><br>
