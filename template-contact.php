...
<div class="container contacts">
    <div class="wrapper">
        ...
        <div class="contact_form">
            ...
            <form method="post" action="<?php the_permalink();?>">
                ...
                <div class="item_line">
                    <textarea name="contact[message]"  placeholder="Message... (required)"id="contact-form-message" required="required"><?php echo isset($_POST['contact']['message']) ? $_POST['contact']['message'] : ''?></textarea>                  
                </div>
                <div class="item_line">
    ...
    <div class="contact_map">
        <?php if( ale_get_meta('address') ) {
            echo do_shortcode('[ale_map address="'. ale_get_meta('address') .'" width="100%" height="400px"]');
        }?>
    </div>    
